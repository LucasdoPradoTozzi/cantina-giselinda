@section('title', 'Criar Novo Motivo de Descarte')
<div>
    <div class="pt-4">
        <x-forms.form wire:submit.prevent="store">
            ...
            <x-forms.button wire:loading.attr="disabled" type="submit">Criar</x-forms.button>
            @if ($errors->has('form'))
